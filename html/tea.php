	...
	<div class="main mt-40 height-large">
		...
		<div class="main-right">
			<div class="thumb-list row">
				<div class="col-xs-12">
					<div class="thumb-list-title"><?php echo $teaList[$_GET['id']]['name']; ?></div>
				</div>
				<?php foreach ($teaList[$_GET['id']]['tea'] as $key => $value) { ?>
				<div class="col-xs-3">
					<a href="detail.php?id=<?php echo $value['id']; ?>" class="thumb-block">
						<div class="thumb-block-image text-center"><img src="<?php echo $value['cover']; ?>"></div>
						<div class="thumb-block-title text-center"><?php echo $value['name']; ?></div>
					</a>
				</div>
				<?php }	 ?>
			</div>
