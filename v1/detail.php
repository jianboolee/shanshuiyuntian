			...
			<div class="row">
				<div class="col-xs-4 bg-gray">
					<div class="pruduct-excerpt">
						<div class=""><img src="./attachment/product/02.jpg"></div>
					</div>
				</div>
				<div class="col-xs-8 bg-gray">
					<div class="pruduct-excerpt bl">
						<div class="">
						<i class="new-product">新品</i>
						<p class="title">2014昔归</p>
						<p>上市时间：2014年</p>
<p>原产地：云南普洱</p>

<p>古树茶树仅在以云南西双版纳勐腊县的古镇易武为首的古六大茶山和勐海县的新六大茶山茶区有古树群落，故而产量十分稀少。古树茶必须是纯料茶，如若在压制茶饼过程中在古树茶叶内掺入台地茶或其它非古树茶叶拼配的，就不再是古树茶，此类茶叶统称为拼配茶。加工技艺精悍的纯料古树茶口感汤色和营养成分如红酒一般，将随着年份而与日俱增，因此，古树茶具备很高的储存升值价值，相较而言，台地茶或拼配茶的储存升值空间较小。</p>
						</div>
					</div>
				</div>
