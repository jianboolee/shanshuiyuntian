		...
		<div class="main-left">
			<ul class="left-nav">
				<li class="subnav subnav-open">
					...
					<a href="#"> 关于我们 </a>
					<ul class="sub-nav">
						<li><a href="enterprise.php"> 公司简介 </a></li>
						<li><a href="contact.php"> 联系我们 </a></li>
						<li><a href="message.php"> 咨询与建议 </a></li>
						<li><a href="agency.php"> 加盟 </a></li>
					</ul>
				</li>
			</ul>
		</div>
		<div class="main-right height-large">
			<div class="page row">
				<div class="col-xs-12">
			...
			<div class="row">
				<div class="col-xs-6">
						<div class="page-content">
							<h4><strong>山水云天昆明营销中心</strong></h4>
							<p>地址：云南省昆明市西山区希望路大商汇国际茶城98栋14、15号</p>
							<p>李小姐：15925115039</p>
							<p><br></p>
							<h4><strong>云南双江勐库古茶树茶厂</strong></h4>
							<p> 地址：云南省临沧市双江县勐库镇城子二组66号</p>
							<p>李先生：13759108673</p>
						</div>
					</div>
					<div class="col-xs-6">
						<p><a href="http://j.map.baidu.com/H3kvx"><img class="img-responsive" src="./attachment/map.png"></a></p>
						<p class="text-center"><a href="http://j.map.baidu.com/H3kvx">查看地图及交通方式</a></p>
					</div>
					<div class="col-xs-12">
					<hr>
					</div>
					<div class="col-xs-6">
						<p class="text-center"><img src="./attachment/qrcode.jpg"></p>
						<p class="text-center text-muted">手机扫描二维码<br>关注微信账号</p>
					</div>
					<div class="col-xs-6">
						<p class="text-center"><img src="./attachment/wechat.jpg"></p>
					</div>
				</div>
			</div>
